...
const handleSubmitLabel=(event)=>{
    ...
    <button className="material-icons">+</button>
        <input aria-label="true" className="LabelInput" type="text" name="labels" value={newLabel.labels} placeholder="Create new label" onChange={handleChangeLabel}></input>
