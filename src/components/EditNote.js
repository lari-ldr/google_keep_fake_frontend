  ...
  render() {
    return (
      <>
        ...
        <div id={this.state.id} className={`NoteModal`}>
          <div className='NoteContainerModal'>
            <div
              className='NoteDesign'
              style={
                ({ borderColor: this.props.note.background_color },
                { backgroundColor: this.props.note.background_color })
              }
            >
              ...
              >
                ...
                <textarea
                  ...
                  cols='10'
                />
                <button className={`SendEdit`} type='submit'>
                  Submit
                </button>
